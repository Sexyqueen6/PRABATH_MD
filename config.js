...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("18768375254")
...
module.exports = {
  ...
  sudo: process.env.SUDO || '18768375254',
  alivepic: process.env.ALIVE_IMG || 'https://telegra.ph/file/ad25b2227fa2a1a01b707.jpg',
  alivemsj: process.env.ALIVE_MSJ || '*POWERD BY LoNlyZak* 🎊',
  ownername:process.env.OWNER_NAME || 'lonlyzak',
  sessionName: process.env.SESSION_ID || 'PRABATH-MD~XSoh3DiC#dPzF9d6Kan3CIv8yjeF2o92b2o9SH5Ba6-Tko_aW1l0',
  author: process.env.PACK_INFO.split(";")[0] || 'author', 
  auto_read_status : process.env.AUTO_READ_STATUS || 'false',
  packname: process.env.PACK_INFO.split(";")[1] || 'lonlyzak',
  ...
  levelupmessage: process.env.LEVEL_UP_MESSAGE || 'falsw',
  antilink: process.env.ANTILINK_VALUES || 'chat.whatsapp.com',
  antilinkaction: process.env.ANTILINK_ACTION || 'warn and delete',
  ...
  BRANCH: 'main',
  ALIVE_MESSAGE: process.env.ALIVE_MESSAGE || 'ypree mi deh yuh eno',
